        ...
        CancellationToken cancellationToken)
    {
        ...
        var activeItems = await db.StudyItems
            ...
            .Select(item => new StudySessionItemResponse(
                ...
                item.StartPage,
                item.EndPage,
                item.SourceMaterial != null ? item.SourceMaterial.Title : item.Topic!.Module.Title,
                item.SourceDocumentChunk != null ? item.SourceDocumentChunk.Heading : item.Topic!.Title,
                item.AttemptCount,
